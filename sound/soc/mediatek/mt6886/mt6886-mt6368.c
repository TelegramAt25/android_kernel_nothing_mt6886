...
/*
 *  mt6886-mt6368.c  --  mt6886 mt6368 ALSA SoC machine driver
 *
 ...
 * mt6886_mt6368_spk_amp_event()
 */
#define EXT_SPK_AMP_W_NAME "Ext_Speaker_Amp"

static struct snd_soc_card mt6886_mt6368_soc_card;

struct mt6886_compress_info compr_info;

static const char *const mt6886_spk_type_str[] = {MTK_SPK_NOT_SMARTPA_STR,
						  MTK_SPK_RICHTEK_RT5509_STR,
						  MTK_SPK_MEDIATEK_MT6660_STR,
						  MTK_SPK_RICHTEK_RT5512_STR,
						  MTK_SPK_GOODIX_TFA98XX_STR};
static const char *const
	mt6886_spk_i2s_type_str[] = {MTK_SPK_I2S_0_STR,
				     MTK_SPK_I2S_1_STR,
				     MTK_SPK_I2S_2_STR,
				     MTK_SPK_I2S_3_STR,
				     MTK_SPK_I2S_5_STR,
...
static const struct soc_enum mt6886_spk_type_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6886_spk_type_str),
			    mt6886_spk_type_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6886_spk_i2s_type_str),
			    mt6886_spk_i2s_type_str),
};

static int mt6886_spk_type_get(struct snd_kcontrol *kcontrol,
...
static int mt6886_spk_i2s_out_type_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6886_spk_i2s_in_type_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6886_compress_info_set(struct snd_kcontrol *kcontrol,
				    const unsigned int __user *data,
				    unsigned int size)
{
	if (copy_from_user(&compr_info,
			   data,
			   sizeof(struct mt6886_compress_info))) {
...
static int mt6886_compress_info_get(struct snd_kcontrol *kcontrol,
				    unsigned int __user *data, unsigned int size)
{
	struct snd_soc_card *card = &mt6886_mt6368_soc_card;
	...
	if (copy_to_user(data, &compr_info, sizeof(struct mt6886_compress_info))) {
...
static int mt6886_mt6368_spk_amp_event(struct snd_soc_dapm_widget *w,
...
static const struct snd_soc_dapm_widget mt6886_mt6368_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6886_mt6368_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6886_mt6368_routes[] = {
...
static const struct snd_kcontrol_new mt6886_mt6368_controls[] = {
	SOC_DAPM_PIN_SWITCH(EXT_SPK_AMP_W_NAME),
	SOC_ENUM_EXT("MTK_SPK_TYPE_GET", mt6886_spk_type_enum[0],
		     mt6886_spk_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6886_spk_type_enum[1],
		     mt6886_spk_i2s_out_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_IN_TYPE_GET", mt6886_spk_type_enum[1],
		     mt6886_spk_i2s_in_type_get, NULL),
	SND_SOC_BYTES_TLV("MTK_COMPRESS_INFO",
			  sizeof(struct mt6886_compress_info),
			  mt6886_compress_info_get, mt6886_compress_info_set),
};

/*
 * define mtk_spk_i2s_mck node in dts when need mclk,
 * BE i2s need assign snd_soc_ops = mt6886_mt6368_i2s_ops
 */
static int mt6886_mt6368_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6886_mt6368_i2s_ops = {
	.hw_params = mt6886_mt6368_i2s_hw_params,
};

static int mt6886_mt6368_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6886_afe_gpio_is_prepared(MT6886_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6886_afe_gpio_is_prepared(MT6886_AFE_GPIO_DAT_MISO1_ON);
	miso2_need_calib = mt6886_afe_gpio_is_prepared(MT6886_AFE_GPIO_DAT_MISO2_ON);
...
static int mt6886_mt6368_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	ops.enable_dc_compensation = mt6886_enable_dc_compensation;
	ops.set_lch_dc_compensation = mt6886_set_lch_dc_compensation;
	ops.set_rch_dc_compensation = mt6886_set_rch_dc_compensation;
	ops.adda_dl_gain_control = mt6886_adda_dl_gain_control;
	...
	/* mtkaif calibration */
	mt6886_mt6368_mtkaif_calibration(rtd);
...
static const struct snd_pcm_hardware mt6886_mt6368_vow_hardware = {
...
static int mt6886_mt6368_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
...
static void mt6886_mt6368_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
...
static const struct snd_soc_ops mt6886_mt6368_vow_ops = {
	.startup = mt6886_mt6368_vow_startup,
	.shutdown = mt6886_mt6368_vow_shutdown,
};
...
static struct snd_soc_dai_link mt6886_mt6368_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
	...
	},
	{
		...
		.ops = &mt6886_mt6368_i2s_ops,
		.no_pcm = 1,
		.dpcm_capture = 1,
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		.be_hw_params_fixup = mt6886_i2s_hw_params_fixup,
...
static struct snd_soc_card mt6886_mt6368_soc_card = {
	.name = "mt6886-mt6368",
	.owner = THIS_MODULE,
	.dai_link = mt6886_mt6368_dai_links,
	.num_links = ARRAY_SIZE(mt6886_mt6368_dai_links),

	.controls = mt6886_mt6368_controls,
	.num_controls = ARRAY_SIZE(mt6886_mt6368_controls),
	.dapm_widgets = mt6886_mt6368_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6886_mt6368_widgets),
	.dapm_routes = mt6886_mt6368_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6886_mt6368_routes),
};

static int mt6886_mt6368_dev_probe(struct platform_device *pdev)
{
	struct snd_soc_card *card = &mt6886_mt6368_soc_card;
...
static const struct of_device_id mt6886_mt6368_dt_match[] = {
	{.compatible = "mediatek,mt6886-mt6368-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6886_mt6368_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6886_mt6368_driver = {
	.driver = {
		.name = "mt6886-mt6368",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6886_mt6368_dt_match,
#endif
		.pm = &mt6886_mt6368_pm_ops,
	},
	.probe = mt6886_mt6368_dev_probe,
};

module_platform_driver(mt6886_mt6368_driver);

/* Module information */
MODULE_DESCRIPTION("MT6886 mt6368 ALSA SoC machine driver");
MODULE_AUTHOR("Shane Chien <shane.chien@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6886 mt6368 soc card");
