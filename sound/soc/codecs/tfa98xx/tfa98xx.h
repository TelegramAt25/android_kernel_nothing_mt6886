...
#endif
	struct proc_dir_entry *proc_dbg_dir;
#ifdef ENABLE_IOCTRL_INTERFACE
...
#if 0
/* add declaration of function by eric.chen for solve user compilation error*/
...
/* move below two function define from .c to .h by eric.chen for solve user compilation error*/
